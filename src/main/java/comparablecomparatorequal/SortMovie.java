...
public class SortMovie {
        ...
        public static class RatingProfitComparator implements Comparator<SortMovie> {
            @Override
            public int compare(SortMovie movie1, SortMovie movie2) {
        ...
        public static class YearRatingComparator implements Comparator<SortMovie> {
            @Override
            public int compare(SortMovie movie1, SortMovie movie2) {
        ...
        public static void main(String[] args) {
            ...
            SortMovie[] movies = {
                    new SortMovie(2020, 8.5, 100000000, 200000000),
                    new SortMovie(2022, 7.8, 80000000, 150000000),
