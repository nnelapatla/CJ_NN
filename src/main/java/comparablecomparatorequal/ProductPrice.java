...
public class ProductPrice implements Comparable<ProductPrice> {
        ...
        @Override
        public int compareTo(ProductPrice otherProduct) {
        ...
        public static void main(String[] args) {
            ...
            ProductPrice product1 = new ProductPrice(1.5, 25.99, 101);
            ProductPrice product2 = new ProductPrice(2.0, 19.99, 102);
